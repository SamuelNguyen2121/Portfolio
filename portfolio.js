...
const translations = {
    ...
    fr: {
        ...
        "table_txt": "Je suis une personne persévérante qui cherche toujours à faire un meilleur travail en s'améliorant avec les commentaires de mon entourage. Par exemple, j'ai l'habileté de m'adapter à différents environnements de travail. La transition du secondaire au cégep m'a amené à développer la capacité d'adaptation puisque les cours devenaient plus exigeants. De plus, ma persévérance joue un rôle important dans le développement de mes compétences personnelles. Au cours de mon emploi d'été durant les dernières années chez Costco, le service à la clientèle étant mon travail principal m'a aidé à développer et à améliorer mes compétences en communication et à apprendre à être patient. De plus, lorsque l'on me confiait des tâches individuelles, j'ai appris à travailler de manière autonome, mais en même temps en équipe lorsque d'autres personnes avaient besoin d'aide. Finalement, changer de département au cours de mes années chez Costco m'a aidé à développer mes compétences d'adaptation.",
        "home_nav": "Accueil",
