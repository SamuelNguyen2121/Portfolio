...
const translations = {
    en: {
        ...
        "education": "Education",
        "dec": "College/CEGEP: DEC in Computer Science and Technology (Acquired)",
        "cegep": "College Champlain, Saint-Lambert (2020 - 2024)",
        "des": "High School: DES (Acquired)",
        "hs": "College Jean de la Mennais, La Prairie (2015 - 2020)",
        "intern": "Web Developer Intern",
        "intern_description": "As a web developer intern, I had to contribute to different ongoing projects at Nucléus. My internship started as a Laravel and ReactJS developer for the internship introductory project where I created a CMS (content management system) app. Then I shifted towards creating website pages with WordPress and Elementor for the company's ongoing projects.",
        "technical": "Technical Skills Acquired",
        "soft": "Soft Skills Acquired",
    ...
    fr: {
        ...
        "education": "Éducation",
        "dec": "Collège/CEGEP: DEC en Informatique (Acquis)",
        "cegep": "Collège Champlain, Saint-Lambert (2020 - 2024)",
        "des": "High School: DES (Acquis)",
        "hs": "Collège Jean de la Mennais, La Prairie (2015 - 2020)",
        "intern": "Stagiaire développeur web",
        "intern_description": "En tant que stagiaire développeur web, j'ai dû contribuer à différents projets en cours chez Nucléus. Mon stage a commencé en tant que développeur Laravel et ReactJS pour le projet d'introduction au stage où j'ai créé une application CMS (Content management system). Ensuite, je me suis orienté vers la création de pages de sites web avec WordPress et Elementor pour les projets en cours de l'entreprise.",
        "technical": "Compétences techniques acquises",
        "soft": "Compétences générales acquises",
